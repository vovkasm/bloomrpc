...
export const Sidebar = observer<SidebarProps>(
  ({ protos, onMethodSelected, onProtoUpload, onDeleteAll, onReload, onMethodDoubleClick }) => {
        ...
        <Navbar className="bp5-dark">
          <NavbarGroup>
            ...
            <Tooltip content="Import proto definitions" placement="bottom">
              <Button intent="primary" icon="plus" onClick={() => importProtos(root, onProtoUpload)} />
            </Tooltip>
            <NavbarDivider />
